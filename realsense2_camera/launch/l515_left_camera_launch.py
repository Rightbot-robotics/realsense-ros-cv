...
configurable_parameters = [{'name': 'camera_name',                  'default': 'l515_left_camera', 'description': 'camera unique name'},
...
def generate_launch_description():
    ...
    return LaunchDescription([
        launch_ros.actions.Node(
            ...
            namespace='l515_left_camera',
            name='l515_left_camera',
